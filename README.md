## The cover page login page.

## Table of Contents
To Start the project
  - Run [`git clone https://github.com/samassango/login-cover-page.git`] to pull the project to your local host.
  - Run [`npm install`] after clonning the project.
  - Run [`npm start`] to start the project
  - Run [`npm test` ]to run the test
  - Run [`npm run build`] to build for deployment to test dev or for producation deployment just add `--prod` after the command.
